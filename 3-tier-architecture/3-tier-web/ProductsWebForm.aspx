<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductsWebForm.aspx.cs" Inherits="_3_tier_web.ProductsWebForm" %>
        ...
        <table align="center" class="auto-style15">
            ...
            <tr>
                ...
                <td class="auto-style4">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" style="height: 26px" Text="Delete" />
                </td>
                <td>
